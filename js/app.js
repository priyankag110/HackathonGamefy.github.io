(function($){
	...
	function loopGallery(test, index, item){
		if(test){
			...
			var mask = $('<div class="mask"><h2>'+item.name+'</h2><p>'+item.description+'</p><a href="img/ara_bleu.jpg" class="info fancybox" rel="group" title="'+item.id+'" ><div class="alt">Click</div></a></div>')
	...
	$.getJSON('https://api.myjson.com/bins/12tiam', function(data){
	...
	$('.next').on('click', function(event){
		...
		$.ajax('https://api.myjson.com/bins/12tiam', {
